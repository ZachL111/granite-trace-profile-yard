"""Regression checks for the granite-trace-profile-yard casebook."""
...
from casebook.harness import assert_expected, granite_trace_profile_yard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(granite_trace_profile_yard_summary(), assert_expected())
